...
Par exemple, \texttt{push 32 r0} fait d'abord transiter l'instruction de la mémoire au processeur: son code, puis  $3$ bits  pour encoder le 32 (encodage \emph{size} dans la table~\ref{tab:constantes}), puis $3$ pour le registre.
