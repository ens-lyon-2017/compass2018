...
\input{figtab}
% mettre figures et tableaux pour les utiliser aussi dans les slides
...
\author{\hspace{-1.5ex}% tout le monde sur la même ligne
...
Les multiplications par 0 terminant instantanément, mais chaque 0 étant tout de même stocké en mémoire comme 64 bits% (en attendant les UNUM...)
...
./emu/emu -i prog/matmul.bin --load 65536:mat32x32.bytes | ./huffman.py > matmul.huff
...
\appendix
\begin{table}[!h]
  \caption{Annexe: Liste des instructions avec leur encodage initial.}
  \label{tab:opcodes}
