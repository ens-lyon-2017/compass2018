...
\newcommand{\figVonNeumann}{
  \begin{tikzpicture}
    \node[hwblock, minimum width=15ex,minimum height=14ex] (p) at (0,0)  {Processeur} ;
    \node[hwblock, minimum width=15ex,minimum height=14ex] (m) at (30ex,0)  {Mémoire} ;
...
#pour le .bin
./asm.py  prog/mult.s -b --loadhuffman mult.huff -o prog/mult.huff.bin 
./emu/emu -s -lh mult.huff -i prog/mult.huff.bin

# Et maintenant la comparaison 
./emu/emu -s  -i prog/mult.bin
...
\begin{table}
  ...
  \begin{tabular}{|c||c|c|c||c|c|c|c|c||c|}
    ...
    binmult, opt &       & 113  & 11.3 &        &        &        &          &        & 445   \\
        \hline
    Chip8        &       &      &      & 63.4\% & 10.8\% & 10.2\% & 7.6\%    & 8.0\%  & 51M   \\
    Chip8 opt    &       &      &      & 63.2\% & 10.7\% & 10.0\% & 7.7\%    & 8.5\%  & 72M   \\ 
    \hline
  \end{tabular}
